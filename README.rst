...
For non-Tutor platforms, you should install the `Python package from Pypi <https://pypi.org/project/openedx-scorm-xblock/>`__::
    ...
    pip install openedx-scorm-xblock==9.5.1 
    or pip install git+git@github.com:edutech-groove/openedx-scorm-xblock.git@open-release/ironwood.master#egg=xblock_scorm
